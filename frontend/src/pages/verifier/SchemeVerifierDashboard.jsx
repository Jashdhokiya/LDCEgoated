              ...
              return (
                <div key={getCaseId(c)} className="bg-surface-lowest rounded-xl border border-border-subtle shadow-sm p-5 flex items-center gap-5 hover:shadow-md transition-shadow">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 bg-primary-override text-white dark:text-shell text-xs font-bold rounded-lg hover:brightness-110 transition-colors shadow-sm whitespace-nowrap"
                  >
