    ...
    <div className="p-8 pb-20">
      ...
      {!loading && error && (
        <div className="flex flex-col items-center justify-center h-64 bg-surface-lowest rounded-xl shadow-sm border border-border-subtle">
          ...
          <button onClick={fetchInstitutions} className="px-4 py-2 bg-primary-override text-white dark:text-shell text-xs font-bold rounded-lg hover:brightness-110 transition-all">
            {t('common.retry')}
          </button>
        </div>
      )}
