            ...
            <div className="px-6 py-5">
              ...
              <div className="flex items-center gap-3 mt-4 pt-4 border-t border-border-subtle">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-primary-override text-white dark:text-shell text-xs font-bold rounded-lg hover:brightness-110 transition-all"
                >
                  <FileSearch size={13} />
