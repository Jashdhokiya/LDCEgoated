...
def main():
    ...
    print("[4/7] Planting 45 deceased anomalies…")
    dreg = plant_deceased(bens, udise, pays, 45)
    print(f"      Death registry: {len(dreg)}")

    print("[5/7] Planting 87 duplicate-identity anomalies…")
    pseq = plant_duplicates(bens, udise, pays, pseq, 87)
    print(f"      Beneficiaries now: {len(bens)}, Payments now: {len(pays)}")

    print("[6/7] Planting 93 undrawn-funds anomalies…")
    plant_undrawn(pays, 93)

    print("[7/7] Planting 22 cross-scheme stacking anomalies…")
    cross = plant_cross_scheme(bens, udise, pays, pseq, 22)
